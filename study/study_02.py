...
class Example(QWidget):
    ...
    def initUI(self):
        self.setGeometry(115, 150, 300, 220)
        self.setWindowTitle('学点编程吧--猜数字')
        self.setWindowIcon(QIcon('beacon.ico'))
    ...
    def closeEvent(self, event):  #重寫父類方法
...
if __name__ == '__main__':
    ...
    ex = Example()
    sys.exit(app.exec_())  #調用應用程序的exec()方法時 應用程序進入主循環