...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(752, 416)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(160, 10, 581, 341))
...
"}")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 30, 571, 281))
        ...
        self.btn_delete.setGeometry(QtCore.QRect(490, 10, 75, 21))
        self.btn_delete.setStyleSheet("QPushButton{\n"
"    background:rgb(255, 70, 24);\n"
"}")
        self.btn_delete.setObjectName("btn_delete")
        self.btn_add = QtWidgets.QPushButton(self.tab)
        self.btn_add.setGeometry(QtCore.QRect(420, 10, 75, 21))
        self.btn_add.setStyleSheet("QPushButton{\n"
"    background:rgb(85, 255, 127);\n"
"}")
        self.btn_add.setObjectName("btn_add")
        self.label_7 = QtWidgets.QLabel(self.tab)
        self.label_7.setGeometry(QtCore.QRect(90, -1, 261, 31))
        self.label_7.setObjectName("label_7")
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.pushButton_6 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_6.setGeometry(QtCore.QRect(370, 33, 75, 21))
        self.pushButton_6.setObjectName("pushButton_6")
        self.pushButton_9 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_9.setGeometry(QtCore.QRect(430, 290, 71, 21))
        self.pushButton_9.setStyleSheet("QPushButton{\n"
"    background:rgb(109, 255, 101);\n"
"\n"
"    font: 12pt \"ADMUI3Lg\";\n"
"}")
        self.pushButton_9.setObjectName("pushButton_9")
        self.pushButton_10 = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_10.setGeometry(QtCore.QRect(500, 290, 71, 21))
...
"}")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(100, 30, 116, 241))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(220, 120, 241, 151))
...
"}")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(220, 33, 135, 81))
...
"}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(10, 370, 71, 23))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(80, 370, 71, 23))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_5 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_5.setGeometry(QtCore.QRect(590, 370, 91, 23))
        self.pushButton_5.setObjectName("pushButton_5")
        self.treeWidget = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget.setGeometry(QtCore.QRect(10, 10, 141, 341))
        self.treeWidget.setObjectName("treeWidget")
        item_0 = QtWidgets.QTreeWidgetItem(self.treeWidget)
        self.btn_save = QtWidgets.QPushButton(self.centralwidget)
        self.btn_save.setGeometry(QtCore.QRect(470, 370, 101, 23))
        self.btn_save.setObjectName("btn_save")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(170, 370, 251, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Modebus主机配置轮询表---New"))
        ...
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "菜单/历史记录"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "New code"))
